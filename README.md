...
Something For The Weekend is a travel inspiration site designed to help users choose a travel destination based on the type of holiday they are looking for. Users are guided through a set of responive sections as they make their decision, and are then presented with local information on their chosen destination. 
...
Wireframes showing the responsive develepment as the user interacts and makes choices
  ...
  - [Wireframe for destination page once user makes inital destination choice, displaying loaction suggestions](https://github.com/annemarie293/SFTW/blob/master/assets/images/wireframes/wireframe-destination-2.jpg)
  - [Wireframe for destination page once user makes location choice, displaying loaction information and local map](https://github.com/annemarie293/SFTW/blob/master/assets/images/wireframes/wireframe-destination-3.jpg)
...
###  CURRENT FEATURES
 ...
 - Destination Page:
    ...
    - Clicking on the "hotels", "restaurants", or "sights" buttons below the locations map replots the markers for the relevant feature. 
    - Link to itinerary page to request personalised travel plan.
    - User can continue to reselect both destination type and loction and the page will respond and display correct informaation.
  - Itinerary Page:
    - Form to complete with required travel information.
    - On submit, form is hidden and page displays a "thank you" message
    - Automated email is recieved by user with submission confrimation details
...
### FUTURE FEATURES TO INCLUDE
 ...
 - Additional API connection to further travel information, weather and booking sites
...
JS Validation
 ...
 - destinations.js
    ...
    - Similiar error to $ variable was found with goole variable, `/*globals google:false */` used to resolve.
    [Errors Screenshot]()
 ...
 - **All Users**
     ...
     1. As a user of this site I want help making a decision where to go on holidays
        ...
        5. Once one of these destination types is clicked, markers are populated on the map below and four buttons are made visible below the map with a the corresponding location names.
     ...
     3. As a user of this site, I want to find out useful information about my holiday destination
        ...
        3. Beside this section (stacked below on mobile/tablet) a new map is dispayed with markers showing hotel locations in the area.
   ...
   4.  As a user of this site, I want to request a more detailed itinerary for my chosen destination
         ...
         4. User recieves an automated email confirming their submitted details, and advising that they will recieve a personalised itinerary shortly.
...
#### Footer
  ...
  - **Bugs found during testing**
    - Social media links were only displayed on the home page, and missing from destinations page and itinerary page. I found that fontawsome link had not been added to thse pages. Issue was resolved once link was added.
...
#### Destination Page
  ...
  - **Tests**
     ...
     2. On page load, contect should only display the Intro text, destination buttons and empty Google map.
        - **_Verified_** 
     3. Each destination button should have corresponding image as background. Buttons should be displayed 4x1 grid on laptops and large sreens, and stacked 2x2 on mobile and tablet screens
        - **_Verified_**  
     ...
     5. When destination button is selected, button style should change to blue background, pink border, white text. When destination button is switched, the style should switch also.
        - **_Verified_** 
     6. When destination button is selected, the map below should display four markers, and four buttons appear below the map with corresponding location names. Buttons should be displayed 4x1 grid on laptops and large sreens, and stacked 2x2 on mobile and tablet screens
        - **_Verified_**
  ...
  - **Bugs found during testing**
    ...
    - Javascript function for the location buttons was not working. I discovered this was because these button elements were added after page load by a previous JS function on click of the destination buttons. Location button functions were wrapped in `$(document).on("DOMNodeInserted", elementID, function ())` function to resolve this issue and fucntion now works correctly.
...
#### Itinerary Page
  ...
  - **Tests**
     ...
     6. Check that all fields are mapped to the correct name when form is submitted (via emailJS email containing form details)
        - **_Verified_** 
    7. User should recieve automated email confirming details submitted. 
        - **_Verified_** 
...
#### Accessibilty
Inital score was also 95. Opportunity to improve refers to aria-hidden="true" property automatically added to fontawsome icons.
#### Best Practices
Inital score was 80. Improvement gained by adding `<link rel="icon" href="data:;base64,iVBORwOKGO=" />` script to html pages to resolve console error for favicon, found at [stackoverflow](https://stackoverflow.com/questions/30693021/chrome-developer-tools-shows-favicon-404-error-in-brackets-livepreview). `rel="noopener"` also adeed to externally opening links. Remaining improvement is to display navbar logo in correct aspect ration, but it fits the navbar better sligtly stretched and does not alter the skew the image for the user.
#### SEO
Inital score was 89, improvement was gained by adding meta description tag to html pages.
___
...
- [FOOD](https://www.shutterstock.com/image-photo/assorted-indian-food-on-dark-wooden-573575497)


- [CITY](https://www.shutterstock.com/image-photo/scenic-summer-aerial-panorama-old-town-1168888273)

- [WINTER](https://www.shutterstock.com/image-photo/winter-new-york-151906451)


- [SUMMER](https://www.shutterstock.com/image-photo/tropical-beach-coconut-palm-tree-1892388787)
